...
프레임워크로부터 독립적인 구성이 하나의 요소인 클린 아키텍처를 이야기하며 리액트를 사용한 클린 아키텍처라는 제목이... 조금 역설적이지만 크게는 웹 프론트에 클린 아키텍처를 도입하는, 작게는 Flux 아키텍처를 기반으로 Redux를 클린 아키텍처와 함께 사용하는 작은 아이디어 샘플 코드입니다.
